...
$PAGE->set_url('/mod/ddtaquiz/comment.php', array('attempt' => $attemptid, 'slot' => $slot));
...
if (!$attemptobj->is_finished()) {
    print_error('attemptclosed', 'ddtaquiz');
}

// Check login and permissions.
require_login($attemptobj->get_course(), false, $attemptobj->get_cm());
$attemptobj->require_capability('mod/ddtaquiz:grade');
...
$PAGE->set_title(get_string('manualgradequestion', 'ddtaquiz', array(
        ...
        'ddtaquiz' => format_string($attemptobj->get_ddtaquiz_name()), 'user' => fullname($student))));
...
// Ddtaquiz name.
$summarydata['ddtaquizname'] = array(
    'title'   => get_string('modulename', 'ddtaquiz'),
    'content' => format_string($attemptobj->get_ddtaquiz_name()),
);
...
<?php
echo '</form>';
$PAGE->requires->js_init_call('M.mod_ddtaquiz.init_comment_popup', null, false, ddtaquiz_get_js_module());
