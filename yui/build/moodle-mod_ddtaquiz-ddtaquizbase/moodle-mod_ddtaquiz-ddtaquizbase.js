YUI.add('moodle-mod_ddtaquiz-ddtaquizbase', function (Y, NAME) {

/**
 * The ddtaquizbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_ddtaquiz-ddtaquizbase
 */
var DDTAQUIZBASENAME = 'mod_ddtaquiz-ddtaquizbase';

var DDTAQUIZBASE = function() {
    DDTAQUIZBASE.superclass.constructor.apply(this, arguments);
};
 ...
 */
M.mod_ddtaquiz.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_ddtaquiz.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
