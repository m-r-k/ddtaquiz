YUI.add('moodle-mod_ddtaquiz-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_ddtaquiz-questionchooser'
});

M.mod_ddtaquiz = M.mod_ddtaquiz || {};
M.mod_ddtaquiz.init_questionchooser = function() {
    M.mod_ddtaquiz.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_ddtaquiz.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_ddtaquiz-util", "querystring-parse"]});
