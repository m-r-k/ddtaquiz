YUI.add('moodle-mod_ddtaquiz-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in ddtaquiz editing page.
 *
...
M.mod_ddtaquiz.repaginate = M.mod_ddtaquiz.repaginate || {};
M.mod_ddtaquiz.repaginate.init = function() {
    return new POPUP();
};
