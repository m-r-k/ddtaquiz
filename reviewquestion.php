...
$baseurl = new moodle_url('/mod/ddtaquiz/reviewquestion.php',
...
if ($attemptobj->is_own_attempt()) {
    if (!$attemptobj->is_finished()) {
        echo $output->review_question_not_allowed($attemptobj, get_string('cannotreviewopen', 'ddtaquiz'));
        die();
...
// Other attempts at the ddtaquiz.
