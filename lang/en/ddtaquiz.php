...
/**
 * Strings for component 'ddtaquiz', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['accessnoticesheader'] = 'You can preview this ddtaquiz, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have ddtaquizzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the ddtaquiz. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the ddtaquiz. This means that different students are likely to get a different selection of questions, and when a ddtaquiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any ddtaquiz in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your ddtaquiz over on the other side of this page.</p>';
...
$string['addquestionstoddtaquiz'] = 'Add questions to current ddtaquiz';
...
$string['addrandomquestiontoddtaquiz'] = 'Add a random question to ddtaquiz {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstoddtaquiz'] = 'Add selected questions to the ddtaquiz';
$string['addselectedtoddtaquiz'] = 'Add selected to ddtaquiz';
$string['addtoddtaquiz'] = 'Add to ddtaquiz';
...
$string['attempterror'] = 'You are not allowed to attempt this ddtaquiz at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid ddtaquiz attempt ID';
$string['attempterrorcontentchange'] = 'This ddtaquiz preview no longer exists. (When a ddtaquiz is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This ddtaquiz attempt no longer exists.';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptddtaquiznow'] = 'Attempt ddtaquiz now';
$string['attempts'] = 'Attempts';
$string['attempts_help'] = 'The total number of attempts allowed (not the number of extra attempts).';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'Ddtaquiz attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during ddtaquiz attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtoddtaquiz'] = 'Back to ddtaquiz editing';
$string['basicideasofddtaquiz'] = 'The basic ideas of ddtaquiz-making';
...
* The ddtaquiz will only start if the student has a JavaScript-enabled web-browser
* The ddtaquiz appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this ddtaquiz has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the ddtaquiz';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this ddtaquiz. The ddtaquiz is set to be graded out of {$a->grade}, but none of the questions in the ddtaquiz have a grade. This can be fixed on the \'Edit ddtaquiz\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this ddtaquiz. The ddtaquiz definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this ddtaquiz. The ddtaquiz has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire ddtaquiz attempt and start another one. This option is mainly useful for practice ddtaquizzes.
...
$string['canredoquestions_help'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire ddtaquiz attempt and start another one. This option is mainly useful for practice ddtaquizzes.
...
$string['closebeforeopen'] = 'Could not update the ddtaquiz. You have specified a close date before the open date.';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the ddtaquiz settings) or higher.';
...
$string['completionattemptsexhausted_help'] = 'Mark ddtaquiz complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the ddtaquiz.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the ddtaquiz.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the ddtaquiz.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a ddtaquiz after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the ddtaquiz.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new ddtaquiz. You can also configure which ddtaquiz settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the ddtaquiz grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the ddtaquiz page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the ddtaquiz editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during ddtaquiz attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the ddtaquiz.';
$string['configrequiresubnet'] = 'Students can only attempt the ddtaquiz from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a ddtaquiz attempt or look at the ddtaquiz reports.';
$string['configshowblocks'] = 'Show blocks during ddtaquiz attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this ddtaquiz, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for ddtaquizzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for ddtaquizzes in seconds. 0 mean no time limit.';
...
$string['continueattemptddtaquiz'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The ddtaquiz is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The ddtaquiz will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to ddtaquiz';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the ddtaquiz.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the ddtaquiz a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the ddtaquiz a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/ddtaquiz folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new ddtaquiz attempt will contain the results of the previous attempt. This allows a ddtaquiz to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingddtaquiz'] = 'Editing ddtaquiz';
$string['editingddtaquiz_help'] = 'When creating a ddtaquiz, the main concepts are:

* The ddtaquiz, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the ddtaquiz and different students can get different questions';
$string['editingddtaquiz_link'] = 'mod/ddtaquiz/edit';
$string['editingddtaquizx'] = 'Editing ddtaquiz: {$a}';
...
$string['editddtaquiz'] = 'Edit ddtaquiz';
$string['editddtaquizquestions'] = 'Edit ddtaquiz questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->ddtaquizname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this ddtaquiz at {$a->ddtaquizurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->ddtaquizname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->ddtaquizname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->ddtaquizname}\' ({$a->ddtaquizurl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->ddtaquizreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->ddtaquizname}. See {$a->ddtaquizreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->ddtaquizname}';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->ddtaquizname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->ddtaquizname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->ddtaquizname}';
$string['empty'] = 'Empty';
...
$string['eventattemptdeleted'] = 'Ddtaquiz attempt deleted';
$string['eventattemptpreviewstarted'] = 'Ddtaquiz attempt preview started';
$string['eventattemptreviewed'] = 'Ddtaquiz attempt reviewed';
$string['eventattemptsummaryviewed'] = 'Ddtaquiz attempt summary viewed';
$string['eventattemptviewed'] = 'Ddtaquiz attempt viewed';
$string['eventeditpageviewed'] = 'Ddtaquiz edit page viewed';
$string['eventoverridecreated'] = 'Ddtaquiz override created';
$string['eventoverridedeleted'] = 'Ddtaquiz override deleted';
$string['eventoverrideupdated'] = 'Ddtaquiz override updated';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventddtaquizattemptabandoned'] = 'Ddtaquiz attempt abandoned';
$string['eventddtaquizattempttimelimitexceeded'] = 'Ddtaquiz attempt time limit exceeded';
$string['eventddtaquizattemptstarted'] = 'Ddtaquiz attempt started';
$string['eventddtaquizattemptsubmitted'] = 'Ddtaquiz attempt submitted';
$string['eventreportviewed'] = 'Ddtaquiz report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the ddtaquiz. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the ddtaquiz when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the ddtaquiz. You have to make a trade-off based on how much you trust the performance of your server during ddtaquizzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final ddtaquiz grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'Ddtaquiz grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->ddtaquizgrade}.';
$string['gradetopassnotset'] = 'This ddtaquiz does not yet have a grade to pass set. It may be set in the Grade section of the ddtaquiz settings.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this ddtaquiz has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt ddtaquizzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a ddtaquiz.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the ddtaquiz';
$string['incorrect'] = 'Incorrect';
$string['indicator:cognitivedepth'] = 'Ddtaquiz cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Ddtaquiz activity.';
$string['indicator:socialbreadth'] = 'Ddtaquiz social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Ddtaquiz activity.';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new ddtaquiz, provide this many blank overall feedback boxes. Once the ddtaquiz has been created, the form shows the number of fields required for the number of feedbacks in the ddtaquiz. The setting must be at least 1.';
...
$string['invalidddtaquizid'] = 'Invalid ddtaquiz ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in ddtaquiz';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->ddtaquiz} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your ddtaquiz attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own ddtaquiz submissions';
$string['messageprovider:submission'] = 'Notification of ddtaquiz submissions';
$string['max'] = 'Max';
...
$string['modulename'] = 'Ddtaquiz';
$string['modulename_help'] = 'The ddtaquiz activity enables a teacher to create ddtaquizzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the ddtaquiz to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/ddtaquiz/view';
$string['modulenameplural'] = 'Ddtaquizzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the ddtaquiz in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the ddtaquiz';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer ddtaquizzes it makes sense to stretch the ddtaquiz over several pages by limiting the number of questions per page. When adding questions to the ddtaquiz, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this ddtaquiz';
...
$string['nogradewarning'] = 'This ddtaquiz is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the ddtaquiz settings.';
...
$string['noquestionsinddtaquiz'] = 'There are no questions in this ddtaquiz.';
...
$string['noreview'] = 'You are not allowed to review this ddtaquiz';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this ddtaquiz until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This ddtaquiz is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the ddtaquiz module. As a work around, set a time limit for the whole ddtaquiz. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this ddtaquiz';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this ddtaquiz';
$string['numberabbr'] = '#';
...
$string['openafterclose'] = 'Could not update the ddtaquiz. You have specified an open date after the close date.';
$string['openclosedatesupdated'] = 'Ddtaquiz open and close dates updated';
...
$string['orderingddtaquiz'] = 'Order and paging';
$string['orderingddtaquizx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a ddtaquiz has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the ddtaquiz before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their ddtaquiz attempt before time expires. If the student is actively working on the ddtaquiz at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/ddtaquiz/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this ddtaquiz to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->ddtaquiz} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->ddtaquiz} - Override';
$string['pageshort'] = 'P';
$string['page-mod-ddtaquiz-x'] = 'Any ddtaquiz module page';
$string['page-mod-ddtaquiz-attempt'] = 'Attempt ddtaquiz page';
$string['page-mod-ddtaquiz-edit'] = 'Edit ddtaquiz page';
$string['page-mod-ddtaquiz-report'] = 'Any ddtaquiz report page';
$string['page-mod-ddtaquiz-review'] = 'Review ddtaquiz attempt page';
$string['page-mod-ddtaquiz-summary'] = 'Ddtaquiz attempt summary page';
$string['page-mod-ddtaquiz-view'] = 'Ddtaquiz information page';
...
$string['pluginadministration'] = 'Ddtaquiz administration';
$string['pluginname'] = 'Ddtaquiz';
$string['popup'] = 'Show ddtaquiz in a &quot;secure&quot; window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the ddtaquiz in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this ddtaquiz in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewddtaquiz'] = 'Preview {$a}';
$string['previewddtaquiznow'] = 'Preview ddtaquiz now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The ddtaquiz activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:ddtaquiz'] = 'The ddtaquiz activity makes use of ddtaquiz reports.';
$string['privacy:metadata:ddtaquiz_attempts'] = 'Details about each attempt on a ddtaquiz.';
$string['privacy:metadata:ddtaquiz_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:ddtaquiz_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:ddtaquiz_attempts:preview'] = 'Whether this is a preview of the ddtaquiz.';
$string['privacy:metadata:ddtaquiz_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:ddtaquiz_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:ddtaquiz_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:ddtaquiz_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:ddtaquiz_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:ddtaquiz_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:ddtaquiz_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:ddtaquiz_grades'] = 'Details about the overall grade for this ddtaquiz.';
$string['privacy:metadata:ddtaquiz_grades:grade'] = 'The overall grade for this ddtaquiz.';
$string['privacy:metadata:ddtaquiz_grades:ddtaquiz'] = 'The ddtaquiz that was graded.';
$string['privacy:metadata:ddtaquiz_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:ddtaquiz_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:ddtaquiz_overrides'] = 'Details about overrides for this ddtaquiz';
$string['privacy:metadata:ddtaquiz_overrides:ddtaquiz'] = 'The ddtaquiz with override information';
$string['privacy:metadata:ddtaquiz_overrides:timeclose'] = 'The new close time for the ddtaquiz.';
$string['privacy:metadata:ddtaquiz_overrides:timelimit'] = 'The new time limit for the ddtaquiz.';
$string['privacy:metadata:ddtaquiz_overrides:timeopen'] = 'The new open time for the ddtaquiz.';
$string['privacy:metadata:ddtaquiz_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:ddtaquizaccess'] = 'The ddtaquiz activity makes use of ddtaquiz access rules.';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->ddtaquiznames}<br />The question will not be deleted from these ddtaquizzes but only from the category list.';
...
$string['questionsinthisddtaquiz'] = 'Questions in this ddtaquiz';
...
$string['ddtaquiz:addinstance'] = 'Add a new ddtaquiz';
$string['ddtaquiz:attempt'] = 'Attempt ddtaquizzes';
$string['ddtaquizavailable'] = 'The ddtaquiz is available until: {$a}';
$string['ddtaquizclose'] = 'Close the ddtaquiz';
$string['ddtaquizclosed'] = 'This ddtaquiz closed on {$a}';
$string['ddtaquizcloses'] = 'Ddtaquiz closes';
$string['ddtaquizeventcloses'] = '{$a} closes';
$string['ddtaquizcloseson'] = 'This ddtaquiz will close at {$a}';
$string['ddtaquiz:deleteattempts'] = 'Delete ddtaquiz attempts';
$string['ddtaquiz:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['ddtaquiz:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['ddtaquiz:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['ddtaquiz:grade'] = 'Grade ddtaquizzes manually';
$string['ddtaquiz:ignoretimelimits'] = 'Ignores time limit on ddtaquizzes';
$string['ddtaquizisclosed'] = 'This ddtaquiz is closed';
$string['ddtaquizisopen'] = 'This ddtaquiz is open';
$string['ddtaquizisclosedwillopen'] = 'Ddtaquiz closed (opens {$a})';
$string['ddtaquizisopenwillclose'] = 'Ddtaquiz open (closes {$a})';
$string['ddtaquiz:manage'] = 'Manage ddtaquizzes';
$string['ddtaquiz:manageoverrides'] = 'Manage ddtaquiz overrides';
$string['ddtaquiznavigation'] = 'Ddtaquiz navigation';
$string['ddtaquizopen'] = 'Open the ddtaquiz';
$string['ddtaquizeventopens'] = '{$a} opens';
$string['ddtaquizopenclose'] = 'Open and close dates';
$string['ddtaquizopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['ddtaquizopenclose_link'] = 'mod/ddtaquiz/timing';
$string['ddtaquizopened'] = 'This ddtaquiz is open.';
$string['ddtaquizopenedon'] = 'This ddtaquiz opened at {$a}';
$string['ddtaquizopens'] = 'Ddtaquiz opens';
$string['ddtaquizopenwillclose'] = 'This ddtaquiz is open, will close on {$a} at';
$string['ddtaquizordernotrandom'] = 'Order of ddtaquiz not shuffled';
$string['ddtaquizorderrandom'] = '* Order of ddtaquiz is shuffled';
$string['ddtaquiz:preview'] = 'Preview ddtaquizzes';
$string['ddtaquiz:regrade'] = 'Regrade ddtaquiz attempts';
$string['ddtaquiz:reviewmyattempts'] = 'Review your own attempts';
$string['ddtaquizsettings'] = 'Ddtaquiz settings';
$string['ddtaquiz:view'] = 'View ddtaquiz information';
$string['ddtaquiz:viewreports'] = 'View ddtaquiz reports';
$string['ddtaquiztimer'] = 'Ddtaquiz Timer';
$string['ddtaquizwillopen'] = 'This ddtaquiz will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole ddtaquiz to be graded.  Are you sure you want to continue?';
$string['reattemptddtaquiz'] = 'Re-attempt ddtaquiz';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this ddtaquiz';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingddtaquiz'] = 'Regrading ddtaquiz "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallddtaquizattempts'] = 'Delete all ddtaquiz attempts';
...
$string['reportusersall'] = 'all users who have attempted the ddtaquiz';
$string['reportuserswith'] = 'enrolled users who have attempted the ddtaquiz';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the ddtaquiz';
$string['reportuserswithout'] = 'enrolled users who have not attempted the ddtaquiz';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the ddtaquiz.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Ddtaquiz access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) ddtaquiz, to ensure that only people in a certain location can access the ddtaquiz.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to ddtaquiz defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after ddtaquiz is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while ddtaquiz is open';
$string['reviewclosed'] = 'After the ddtaquiz is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->ddtaquiz} by {$a->user}';
$string['reviewopen'] = 'Later, while the ddtaquiz is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a ddtaquiz attempt or look at the ddtaquiz reports.
...
**Later, while the ddtaquiz is still open** settings apply after this, and before the ddtaquiz close date.

**After the ddtaquiz is closed** settings apply after the ddtaquiz close date has passed. If the ddtaquiz does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current ddtaquiz attempt.';
...
$string['saveddtaquiz'] = 'Save this whole ddtaquiz';
...
$string['search:activity'] = 'Ddtaquiz - activity information';
...
$string['showblocks'] = 'Show blocks during ddtaquiz attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during ddtaquiz attempts';
...
$string['shufflequestions_help'] = 'If you turn this on, then every time the ddtaquiz is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the ddtaquiz, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonddtaquiz'] = 'Specified question is not on the specified ddtaquiz';
...
$string['subneterror'] = 'Sorry, this ddtaquiz has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this ddtaquiz.';
$string['subnetnotice'] = 'This ddtaquiz has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_ddtaquiz'] = 'Report';
$string['subplugintype_ddtaquiz_plural'] = 'Reports';
$string['subplugintype_ddtaquizaccess'] = 'Access rule';
$string['subplugintype_ddtaquizaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the ddtaquiz.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the ddtaquiz since you have not passed the time delay before attempting another ddtaquiz';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial ddtaquiz page and a countdown timer is displayed in the ddtaquiz navigation block.';
$string['timelimit_link'] = 'mod/ddtaquiz/timing';
$string['timelimitexeeded'] = 'Sorry! Ddtaquiz time limit exceeded!';
...
$string['updatesettings'] = 'Update ddtaquiz settings';
$string['updateddtaquizslotswithrandomxofy'] = 'Updating ddtaquiz slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the ddtaquiz module will perform an extensive change of the ddtaquiz tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingddtaquizattempts'] = 'Upgrading ddtaquiz attempts: ddtaquiz {$a->done}/{$a->outof} (Ddtaquiz id {$a->info})';
$string['upgradingveryoldddtaquizattempts'] = 'Upgrading very old ddtaquiz attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this ddtaquiz';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} ddtaquiz attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this ddtaquiz';
$string['yourfinalgradeis'] = 'Your final grade for this ddtaquiz is {$a}.';
