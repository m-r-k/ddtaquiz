...
/**
 * The mod_ddtaquiz attempt became overdue event.
 *
...
/**
 * The mod_ddtaquiz attempt became overdue event class.
 *
 ...
 *      - int ddtaquizid: (optional) the id of the ddtaquiz.
 * }
 *
 * @package    mod_ddtaquiz
 * @since      Moodle 2.6
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The ddtaquiz attempt with id '$this->objectid' belonging to the ddtaquiz with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventddtaquizattempttimelimitexceeded', 'mod_ddtaquiz');
    }
    ...
    static public function get_legacy_eventname() {
        return 'ddtaquiz_attempt_overdue';
    }
    ...
    protected function get_legacy_eventdata() {
        $attempt = $this->get_record_snapshot('ddtaquiz_attempts', $this->objectid);

        $legacyeventdata = new \stdClass();
        $legacyeventdata->component = 'mod_ddtaquiz';
        ...
        $legacyeventdata->ddtaquizid = $attempt->ddtaquiz;
