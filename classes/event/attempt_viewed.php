...
/**
 * The mod_ddtaquiz attempt viewed event.
 *
...
/**
 * The mod_ddtaquiz attempt viewed event class.
 *
...
class attempt_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptviewed', 'mod_ddtaquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the attempt with id '$this->objectid' belonging to the user " .
            "with id '$this->relateduserid' for the ddtaquiz with course module id '$this->contextinstanceid'.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ddtaquiz', 'continue attempt', 'review.php?attempt=' . $this->objectid,
