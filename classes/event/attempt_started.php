...
class attempt_started extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has started the attempt with id '$this->objectid' for the " .
            "ddtaquiz with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventddtaquizattemptstarted', 'mod_ddtaquiz');
    }
    ...
    static public function get_legacy_eventname() {
        return 'ddtaquiz_attempt_started';
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'ddtaquiz', 'attempt', 'review.php?attempt=' . $this->objectid,
            $attempt->ddtaquiz, $this->contextinstanceid);
    }
