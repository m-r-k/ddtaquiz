...
/**
 * The mod_ddtaquiz edit page viewed event.
 *
...
/**
 * The mod_ddtaquiz edit page viewed event class.
 *
...
class edit_page_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventeditpageviewed', 'mod_ddtaquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the edit page for the ddtaquiz with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ddtaquiz', 'editquestions', 'view.php?id=' . $this->contextinstanceid,
