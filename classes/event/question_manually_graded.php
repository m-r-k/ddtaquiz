...
class question_manually_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquestionmanuallygraded', 'mod_ddtaquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' manually graded the question with id '$this->objectid' for the attempt " .
            "with id '{$this->other['attemptid']}' for the ddtaquiz with course module id '$this->contextinstanceid'.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ddtaquiz', 'manualgrade', 'comment.php?attempt=' . $this->other['attemptid'] .
            '&slot=' . $this->other['slot'], $this->other['ddtaquizid'], $this->contextinstanceid);
    }
    ...
    public static function get_other_mapping() {
        ...
        $othermapped['attemptid'] = array('db' => 'ddtaquiz_attempts', 'restore' => 'ddtaquiz_attempt');
