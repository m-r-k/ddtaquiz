...
/**
 * The mod_ddtaquiz attempt abandoned event.
 *
...
/**
 * The mod_ddtaquiz attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int ddtaquizid: (optional) id of the ddtaquiz.
 * }
 *
 * @package    mod_ddtaquiz
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the ddtaquiz with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventddtaquizattemptabandoned', 'mod_ddtaquiz');
    }
    ...
    static public function get_legacy_eventname() {
        return 'ddtaquiz_attempt_abandoned';
    }
