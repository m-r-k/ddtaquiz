...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'mod_ddtaquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the report '" . s($this->other['reportname']) . "' for the ddtaquiz with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ddtaquiz', 'report', 'report.php?id=' . $this->contextinstanceid . '&mode=' .
            $this->other['reportname'], $this->other['ddtaquizid'], $this->contextinstanceid);
    }
