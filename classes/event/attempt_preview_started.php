...
class attempt_preview_started extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptpreviewstarted', 'mod_ddtaquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' previewed by " .
            "the user with id '$this->userid' for the ddtaquiz with course module id '$this->contextinstanceid'.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ddtaquiz', 'preview', 'view.php?id=' . $this->contextinstanceid,
