...
/**
 * Privacy Subsystem helper for mod_ddtaquiz.
 *
...
class helper {
    /**
     * Determine the subcontext for the specified ddtaquiz attempt.
     *
     * @param   \stdClass       $attempt    The attempt data retrieved from the database.
     * @param   \stdClass       $user       The user record.
     * @return  \array                      The calculated subcontext.
     */
    public static function get_ddtaquiz_attempt_subcontext(\stdClass $attempt, \stdClass $user) {
        $subcontext = [
