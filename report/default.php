...
/**
 * Base class for ddtaquiz report plugins.
 *
 ...
 * This class displays ddtaquiz reports.  Because it is called from
 * within /mod/ddtaquiz/report.php you can assume that the page header
 * and footer are taken care of.
 *
 * This file can refer to itself as report.php to pass variables
 * to itself - all these will also be globally available.  You must
 * pass "id=$cm->id" or q=$ddtaquiz->id", and "mode=reportname".
 *
 * @copyright 1999 onwards Martin Dougiamas and others {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class ddtaquiz_default_report {
    const NO_GROUPS_ALLOWED = -2;

    /**
     * Override this function to displays the report.
     * @param $cm the course-module for this ddtaquiz.
     * @param $course the coures we are in.
     * @param $ddtaquiz this ddtaquiz.
     */
    public abstract function display($cm, $course, $ddtaquiz);
     ...
     */
    public function print_header_and_tabs($cm, $course, $ddtaquiz, $reportmode = 'overview') {
        global $PAGE, $OUTPUT;

        // Print the page header.
        $PAGE->set_title($ddtaquiz->name);
