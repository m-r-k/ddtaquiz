...
/**
 * Strings for component 'ddtaquiz_overview', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['nogradepermission'] = 'You don\'t have permission to grade this ddtaquiz.';
$string['onlyoneattemptallowed'] = 'Only one attempt per user allowed on this ddtaquiz.';
$string['optallattempts'] = 'all attempts';
$string['optallstudents'] = 'all {$a} who have or have not attempted the ddtaquiz';
$string['optattemptsonly'] = '{$a} who have attempted the ddtaquiz';
$string['optnoattemptsonly'] = '{$a} who have not attempted the ddtaquiz';
...
$string['privacy:metadata:preference:ddtaquiz_overview_slotmarks'] = 'Whether to show marks for each question slot.';
...
$string['showinggradedandungraded'] = 'Showing graded and ungraded attempts for each user. The one attempt for each user that is graded is highlighted. The grading method for this ddtaquiz is {$a}.';
