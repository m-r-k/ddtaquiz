...
/**
 * Class to store the options for a {@link ddtaquiz_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ddtaquiz_overview_options extends mod_ddtaquiz_attempts_report_options {
    ...
    public function update_user_preferences() {
        ...
        if (ddtaquiz_has_grades($this->ddtaquiz)) {
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/ddtaquiz:regrade', 'mod/ddtaquiz:deleteattempts'), context_module::instance($this->cm->id))
