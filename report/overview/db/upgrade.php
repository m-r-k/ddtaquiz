...
/**
 * Ddtaquiz overview report upgrade script.
 *
...
/**
 * Ddtaquiz overview report upgrade function.
 * @param number $oldversion
 */
function xmldb_ddtaquiz_overview_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2018061800) {
        ...
        // Define key questionusageid-slot (foreign) to be dropped form ddtaquiz_overview_regrades.
        $table = new xmldb_table('ddtaquiz_overview_regrades');
        ...
        upgrade_plugin_savepoint(true, 2018061800, 'ddtaquiz', 'overview');
    }

    if ($oldversion < 2018061801) {

        // Define key questionusageid-slot (foreign) to be added to ddtaquiz_overview_regrades.
        $table = new xmldb_table('ddtaquiz_overview_regrades');
        $key = new xmldb_key('questionusageid-slot', XMLDB_KEY_FOREIGN, array('questionusageid', 'slot'), 'question_attempts', array('questionusageid', 'slot'));
        ...
        // Overview savepoint reached.
        upgrade_plugin_savepoint(true, 2018061801, 'ddtaquiz', 'overview');
    }
