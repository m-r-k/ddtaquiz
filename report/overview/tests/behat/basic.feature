@mod @mod_ddtaquiz @ddtaquiz @ddtaquiz_overview
Feature: Basic use of the Grades report
  In order to easily get an overview of ddtaquiz attempts
  As a teacher
  ...
  Scenario: Using the Grades report
    ...
    And I set the field "Attempts from" to "enrolled users who have not attempted the ddtaquiz"
    ...
    And I set the field "Attempts from" to "enrolled users who have, or have not, attempted the ddtaquiz"
    And I press "Show report"
    # Check student1's grade
    And I should see "25.00" in the "S1 Student1" "table_row"
    ...
    And I set the field "Attempts from" to "all users who have attempted the ddtaquiz"
    And I press "Show report"
    # Check student1's grade
    And I should see "25.00" in the "S1 Student1" "table_row"
    # Check student2's grade
