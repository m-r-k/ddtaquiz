...
/**
 * This file defines the ddtaquiz responses table for showing last try at question.
 *
...
/**
 * This is a table subclass for displaying the ddtaquiz responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ddtaquiz_last_responses_table extends ddtaquiz_attempts_report_table {
     ...
     * @param ddtaquiz_responses_options $options
     * @param \core\dml\sql_join $groupstudentsjoins
     * @param \core\dml\sql_join $studentsjoins
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($ddtaquiz, $context, $qmsubselect, ddtaquiz_responses_options $options,
            \core\dml\sql_join $groupstudentsjoins, \core\dml\sql_join $studentsjoins, $questions, $reporturl) {
        parent::__construct('mod-ddtaquiz-report-responses-report', $ddtaquiz, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->ddtaquiz->id . '&amp;attempt=' .
