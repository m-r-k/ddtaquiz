...
/**
 * Class to store the options for a {@link ddtaquiz_responses_report}.
 *
...
require_once($CFG->dirroot . '/mod/ddtaquiz/report/attemptsreport_options.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ddtaquiz_responses_options extends mod_ddtaquiz_attempts_report_options {
    ...
    protected function get_url_params() {
        ...
        if (ddtaquiz_allows_multiple_tries($this->ddtaquiz)) {
    ...
    public function setup_from_user_preferences() {
        ...
        if (ddtaquiz_allows_multiple_tries($this->ddtaquiz)) {
            $this->whichtries    = get_user_preferences('ddtaquiz_report_responses_which_tries', $this->whichtries);
        }
    }
    ...
    public function update_user_preferences() {
        ...
        if (ddtaquiz_allows_multiple_tries($this->ddtaquiz)) {
            set_user_preference('ddtaquiz_report_responses_which_tries', $this->whichtries);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_capability('mod/ddtaquiz:deleteattempts', context_module::instance($this->cm->id))
                && ($this->attempts != ddtaquiz_attempts_report::ENROLLED_WITHOUT);
    }
}
