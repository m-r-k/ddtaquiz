...
/**
 * Strings for component 'ddtaquiz_grading', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['gradingnotallowed'] = 'You do not have permission to manually grade responses in this ddtaquiz';
...
$string['privacy:metadata'] = 'The Ddtaquiz Manual grading plugin does not store any personal data. It provides an interface for users to store data without storing any data itself.';
$string['qno'] = 'Q #';
