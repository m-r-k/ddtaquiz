...
/**
 * Unit tests for usage of tags in ddtaquizzes.
 *
...
/**
 * Class mod_ddtaquiz_tags_testcase
 * Class for tests related to usage of question tags in ddtaquizzes.
 *
 * @copyright  2018 Shamim Rezaie <shamim@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_ddtaquiz_tags_testcase extends advanced_testcase {
    public function test_restore_random_question_by_tag() {
        ...
        get_file_packer('application/vnd.moodle.backup')->extract_to_pathname(
                __DIR__ . "/fixtures/random_by_tag_ddtaquiz.mbz", $backuppath);
        ...
        $ddtaquiz = array_values($modinfo->get_instances_of('ddtaquiz'))[0];
        $ddtaquizobj = ddtaquiz::create($ddtaquiz->instance);
        ...
        $slottags = ddtaquiz_retrieve_slot_tags($question->slotid);
        $this->assertEquals(
                [
