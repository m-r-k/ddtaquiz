@mod @mod_ddtaquiz
Feature: Edit ddtaquiz page - section headings
  In order to build a ddtaquiz laid out in sections the way I want
  As a teacher
  ...
  @javascript
  Scenario: We have a ddtaquiz with one default section
  ...
  Scenario: Modify the default section headings
    ...
    And I follow "Ddtaquiz 1"
    And I navigate to "Edit ddtaquiz" in current page administration
    And I change ddtaquiz section heading "" to "This is section one"
 ...
 @javascript
  Scenario: Modify section headings
    ...
    And I navigate to "Edit ddtaquiz" in current page administration
    And I change ddtaquiz section heading "" to "This is section one"
    And I change ddtaquiz section heading "Heading 2" to "This is section two"
    Then I should see "This is section one"
  ...
  Scenario: Set section headings to blanks
    ...
    And I follow "Ddtaquiz 1"
    And I navigate to "Edit ddtaquiz" in current page administration
    When I change ddtaquiz section heading "Heading 1" to ""
    Then I should not see "Heading 1"
    And I should see "Heading 2"
    And I should see "Heading 3"

    And I change ddtaquiz section heading "Heading 2" to ""
    And I should not see "Heading 1"
    And I should not see "Heading 2"
    And I should see "Heading 3"

    And I change ddtaquiz section heading "Heading 3" to ""
    And I should not see "Heading 1"
    And I should not see "Heading 2"
  ...
  Scenario: The edit-icon tool-tips are updated when a section is edited
    ...
    And I follow "Ddtaquiz 1"
    And I navigate to "Edit ddtaquiz" in current page administration
    And I change ddtaquiz section heading "Heading 2" to "Edited heading"
  ...
  Scenario: Moving a question up from section 3 to the first section.
    ...
    And I follow "Ddtaquiz 1"
    And I navigate to "Edit ddtaquiz" in current page administration
    And I move "TF5" to "After Question 2" in the ddtaquiz by clicking the move icon
    Then I should see "TF5" on ddtaquiz page "2"
  ...
  Scenario: moving a question down from the first section to the second section.
    ...
    And I follow "Ddtaquiz 1"
    And I navigate to "Edit ddtaquiz" in current page administration
    And I move "TF1" to "After Question 3" in the ddtaquiz by clicking the move icon
    Then I should see "TF1" on ddtaquiz page "2"

  @javascript
  Scenario: I should not see a delete icon for the first section in the ddtaquiz.
    Given the following "activities" exist:
      | activity   | name   | intro              | course | idnumber |
      | ddtaquiz       | Ddtaquiz 1 | Ddtaquiz 1 description | C1     | ddtaquiz1    |
    And the following "questions" exist:
  ...
  Scenario: Turn shuffling on for a section
    ...
    And I follow "Ddtaquiz 1"
    And I navigate to "Edit ddtaquiz" in current page administration
    And I click on shuffle for section "Heading 1" on the ddtaquiz edit page
    And I click on shuffle for section "Heading 2" on the ddtaquiz edit page
    Then shuffle for section "Heading 1" should be "On" on the ddtaquiz edit page
    And shuffle for section "Heading 2" should be "On" on the ddtaquiz edit page
  ...
  Scenario: Turn shuffling off for a section
    ...
    And I click on shuffle for section "Heading 1" on the ddtaquiz edit page
    And I click on shuffle for section "Heading 2" on the ddtaquiz edit page
    Then shuffle for section "Heading 1" should be "Off" on the ddtaquiz edit page
    And shuffle for section "Heading 2" should be "Off" on the ddtaquiz edit page
    And I reload the page
    And shuffle for section "Heading 1" should be "Off" on the ddtaquiz edit page
    And shuffle for section "Heading 2" should be "Off" on the ddtaquiz edit page
  ...
  Scenario: Verify sections are added in the right place afte ajax changes
    ...
    And I open the "Page 2" add to ddtaquiz menu
  ...
  Scenario: Add section works after removing a page break with more than 10 pages
    ...
    And I open the "Page 10" add to ddtaquiz menu
    And I choose "a new section heading" in the open action menu
