@mod @mod_ddtaquiz
Feature: Edit ddtaquiz page - remove multiple questions
  In order to change the layout of a ddtaquiz I built efficiently
  As a teacher
  ...
  # Confirm the starting point.
    Then I should see "Question A" on ddtaquiz page "1"
    And I should see "Question B" on ddtaquiz page "2"
    And I should see "Question C" on ddtaquiz page "2"
    And I should see "Total of marks: 3.00"
    And I should see "Questions: 3"
    And I should see "This ddtaquiz is open"
  ...
  # Delete first question in first page. Page contains multiple questions. No reordering.
    ...
    Then I should not see "Question A" on ddtaquiz page "1"
    And I should see "Question B" on ddtaquiz page "1"
  ...
  # Delete all questions in page. Page contains multiple questions
    ...
    Then I should not see "Question A" on ddtaquiz page "1"
    And I should not see "Question B" on ddtaquiz page "1"
    And I should not see "Question C" on ddtaquiz page "2"
