@mod @mod_ddtaquiz @javascript
Feature: Ddtaquiz user override
  In order to grant a student special access to a ddtaquiz
  As a teacher
  ...
  Scenario: Being able to modify a user override when the ddtaquiz is not available to the student
    Given I follow "Ddtaquiz 1"
