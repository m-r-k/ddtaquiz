@mod @mod_ddtaquiz
Feature: Edit ddtaquiz page - adding things
  In order to build the ddtaquiz I want my students to attempt
  As a teacher
  I need to be able to add questions to the ddtaquiz.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | ddtaquiz       | Ddtaquiz 1 | Ddtaquiz 1 for testing the Add menu | C1     | ddtaquiz1    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Ddtaquiz 1"
    And I navigate to "Edit ddtaquiz" in current page administration
    Then I should see "Editing ddtaquiz: Ddtaquiz 1"

  @javascript
  Scenario: Add some new question to the ddtaquiz using '+ a new question' options of the 'Add' menu.
    And I open the "last" add to ddtaquiz menu
    ...
    Then I should see "Editing ddtaquiz: Ddtaquiz 1"
    And I should see "Essay 01 new" on ddtaquiz page "1"

    And I open the "Page 1" add to ddtaquiz menu
    And I follow "a new question"
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    Then I should see "Editing ddtaquiz: Ddtaquiz 1"
    And I should see "Essay 01 new" on ddtaquiz page "1"
    And I should see "Essay 02 new" on ddtaquiz page "1"
    ...
    And I should see "Essay 01 new" on ddtaquiz page "1"
    And I should see "Essay 02 new" on ddtaquiz page "1"
    And I should see "Essay 03 new" on ddtaquiz page "1"
    ...
    And I should see "Essay 02 new" on ddtaquiz page "1"
    And I should see "Essay 03 new" on ddtaquiz page "1"
    And I should see "Essay 04 new" on ddtaquiz page "1"
    ...
    And I should see "Essay 01 new" on ddtaquiz page "1"
    And I should see "Essay 02 new" on ddtaquiz page "1"
    And I should see "Essay 03 new" on ddtaquiz page "2"
    And I should see "Essay 04 new" on ddtaquiz page "2"

    # Add a question to page 2.
    When I open the "Page 2" add to ddtaquiz menu
    ...
    And I should see "Essay 03 new" on ddtaquiz page "2"
    And I should see "Essay 04 new" on ddtaquiz page "2"
    And I should see "Essay for page 2" on ddtaquiz page "2"

  @javascript
  Scenario: Add questions from question bank to the ddtaquiz. In order to be able to
      add questions from question bank to the ddtaquiz, first we create some new questions
    ...
    Then the "Add selected questions to the ddtaquiz" "button" should be disabled
    And I click on "Essay 03" "checkbox"
    Then the "Add selected questions to the ddtaquiz" "button" should be enabled
    And I click on "Add to ddtaquiz" "link" in the "Essay 03" "table_row"
    Then I should see "Editing ddtaquiz: Ddtaquiz 1"
    And I should see "Essay 03" on ddtaquiz page "1"

    # Add Essay 01 from question bank.
    And I open the "Page 1" add to ddtaquiz menu
    And I follow "from question bank"
    And I click on "Add to ddtaquiz" "link" in the "Essay 01" "table_row"
    Then I should see "Editing ddtaquiz: Ddtaquiz 1"
    And I should see "Essay 03" on ddtaquiz page "1"
    And I should see "Essay 01" on ddtaquiz page "1"
    ...
    And I should see "Select a category"
    And I set the field "Select a category" to "Subcat 1"
    And I click on "Add to ddtaquiz" "link" in the "Essay 02" "table_row"
    Then I should see "Editing ddtaquiz: Ddtaquiz 1"
    And I should see "Essay 03" on ddtaquiz page "1"
    And I should see "Essay 01" on ddtaquiz page "1"
    And I should see "Essay 02" on ddtaquiz page "1"
    ...
    And I should see "Essay 01" on ddtaquiz page "1"
    And I should see "Essay 02" on ddtaquiz page "1"
    And I should see "Random" on ddtaquiz page "1"
    ...
    When I press "Go"
    And I should see "Essay 03" on ddtaquiz page "1"
    And I should see "Essay 01" on ddtaquiz page "2"
    And I should see "Essay 02" on ddtaquiz page "3"
    And I should see "Random" on ddtaquiz page "4"

    # Add a random question to page 4.
    And I open the "Page 4" add to ddtaquiz menu
    And I choose "a new question" in the open action menu
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    And I should see "Essay 02" on ddtaquiz page "3"
    And I should see "Random" on ddtaquiz page "4"
    And I should see "Essay for page 4" on ddtaquiz page "4"
