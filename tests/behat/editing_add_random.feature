...
Feature: Adding random questions to a ddtaquiz based on category and tags
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | ddtaquiz       | Ddtaquiz 1 | Ddtaquiz 1 for testing the Add random question form | C1     | ddtaquiz1    |
