@mod @mod_ddtaquiz
Feature: Preview a ddtaquiz as a teacher
  In order to verify my ddtaquizzes are ready for my students
  As a teacher
  ...
  @javascript
  Scenario: Preview a ddtaquiz
    When I follow "Ddtaquiz 1"
    And I press "Preview ddtaquiz now"
