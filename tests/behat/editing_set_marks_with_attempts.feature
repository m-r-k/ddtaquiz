@mod @mod_ddtaquiz
Feature: Edit ddtaquiz marks with attempts
  In order to create a ddtaquiz that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit ddtaquiz page (even after the ddtaquiz has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | ddtaquiz       | Ddtaquiz 1 | C1     | ddtaquiz1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add a "True/False" question to the "Ddtaquiz 1" ddtaquiz with:
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the ddtaquiz settings say it should be.
