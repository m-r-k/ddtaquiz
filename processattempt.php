...
/**
 * This page deals with processing responses during an attempt at a ddtaquiz.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_ddtaquiz_exception($attemptobj->get_ddtaquizobj(),
...
if ($status == ddtaquiz_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == ddtaquiz_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
