 ...
 *
 * @module     mod_ddtaquiz/modal_ddtaquiz_question_bank
...
function(
    ...
    var SELECTORS = {
        ADD_TO_DDTAQUIZ_CONTAINER: 'td.addtoddtaquizaction',
        ANCHOR: 'a[href]',
     ...
     */
    var ModalDdtaquizQuestionBank = function(root) {
    ...
    ModalDdtaquizQuestionBank.TYPE = 'mod_ddtaquiz-ddtaquiz-question-bank';
    ModalDdtaquizQuestionBank.prototype = Object.create(Modal.prototype);
    ModalDdtaquizQuestionBank.prototype.constructor = ModalDdtaquizQuestionBank;
     ...
     * @param {int} id
     */
    ModalDdtaquizQuestionBank.prototype.setContextId = function(id) {
        this.contextId = id;
    };
     ...
     * @return {int}
     */
    ModalDdtaquizQuestionBank.prototype.getContextId = function() {
        return this.contextId;
    };

    /**
     * Set the id of the page that the question should be added to
     * when the user clicks the add to ddtaquiz link.
     *
     * @method setAddOnPageId
     * @param {int} id
     */
    ModalDdtaquizQuestionBank.prototype.setAddOnPageId = function(id) {
        this.addOnPageId = id;
    };
     ...
     * @return {int}
     */
    ModalDdtaquizQuestionBank.prototype.getAddOnPageId = function() {
     ...
     * @return {void}
     */
    ModalDdtaquizQuestionBank.prototype.show = function() {
     ...
     */
    ModalDdtaquizQuestionBank.prototype.reloadBodyContent = function(queryString) {
        // Load the question bank fragment to be displayed in the modal.
        var promise = Fragment.loadFragment(
            'mod_ddtaquiz',
            'ddtaquiz_question_bank',
            this.getContextId(),
            {
     ...
     *
     * @method handleAddToDdtaquizEvent
     * @param {event} e A JavaScript event
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalDdtaquizQuestionBank.prototype.handleAddToDdtaquizEvent = function(e, anchorElement) {
     ...
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalDdtaquizQuestionBank.prototype.handlePreviewContainerEvent = function(e, anchorElement) {
        var popupOptions = [
            'height=600',
            'width=800',
            'top=0',
     ...
     * @param {event} e A JavaScript event
     */
    ModalDdtaquizQuestionBank.prototype.handleDisplayOptionFormEvent = function(e) {
     ...
     *      - The ddtaquiz category select box
     ...
     */
    ModalDdtaquizQuestionBank.prototype.registerDisplayOptionListeners = function() {
        // Listen for changes to the display options form.
     ...
     */
    ModalDdtaquizQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to ddtaquiz link.
            if (anchorElement.closest(SELECTORS.ADD_TO_DDTAQUIZ_CONTAINER).length) {
                this.handleAddToDdtaquizEvent(e, anchorElement);
                return;
            }
    ...
    if (!registered) {
        ModalRegistry.register(
            ModalDdtaquizQuestionBank.TYPE,
            ModalDdtaquizQuestionBank,
            'core/modal'
        );
    ...
    return ModalDdtaquizQuestionBank;
});
