 ...
 *
 * @module     mod_ddtaquiz/modal_add_random_question
...
function(
    ...
    ModalAddRandomQuestion.TYPE = 'mod_ddtaquiz-ddtaquiz-add-random-question';
    ...
    if (!registered) {
        ModalRegistry.register(
            ...
            'mod_ddtaquiz/modal_add_random_question'
        );
