 ...
 *
 * This is also responsible for opening the pop-up window, if the ddtaquiz requires to be in one.
 *
 * @module    mod_ddtaquiz/preflightcheck
...
define(['jquery', 'core/yui'], function($, Y) {
    ...
    /**
     * @alias module:mod_ddtaquiz/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the ddtaquiz should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_ddtaquiz_preflight_popup']
                    });
                ...
                if (popupoptions) {
                    Y.one(finalStartButton).on('click', t.launchDdtaquizPopup, t, popupoptions);
                }
            });
        },
        ...
        /**
         * Event handler for the ddtaquiz start attempt button.
          * @param {Event} e the event being responded to
          * @param {Object} popupoptions
         */
        launchDdtaquizPopup: function(e, popupoptions) {
            e.halt();
