...
/**
 * Base class for rules that restrict the ability to attempt a ddtaquiz.
 *
...
/**
 * A base class that defines the interface for the various ddtaquiz access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class ddtaquiz_access_rule_base {
    /** @var stdClass the ddtaquiz settings. */
    protected $ddtaquiz;
    /** @var ddtaquiz the ddtaquiz object. */
    protected $ddtaquizobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular ddtaquiz.
     * @param ddtaquiz $ddtaquizobj information about the ddtaquiz in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($ddtaquizobj, $timenow) {
        $this->ddtaquizobj = $ddtaquizobj;
        $this->ddtaquiz = $ddtaquizobj->get_ddtaquiz();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given ddtaquiz, otherwise return null.
     * @param ddtaquiz $ddtaquizobj information about the ddtaquiz in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/ddtaquiz:ignoretimelimits capability.
     * @return ddtaquiz_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_ddtaquiz_preflight_check_form $ddtaquizform the form being built.
    ...
    /**
     * This is called when the current attempt at the ddtaquiz is finished. This is
    ...
    /**
     * Information, such as might be shown on the ddtaquiz view page, relating to this restriction.
     ...
     * this ddtaquiz, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the ddtaquiz settings form. This
     * method is called from {@link mod_ddtaquiz_mod_form::definition()}, while the
    ...
    /**
     * Save any submitted settings when the ddtaquiz settings form is submitted. This
     * is called from {@link ddtaquiz_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the ddtaquiz is deleted. This is called
     * from {@link ddtaquiz_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link ddtaquiz_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $ddtaquizid the id of the ddtaquiz we are loading settings for. This
     *     can also be accessed as ddtaquiz.id in the SQL. (ddtaquiz is a table alisas for {ddtaquiz}.)
     ...
     */
    public static function get_settings_sql($ddtaquizid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($ddtaquizid) {
        return array();
    }
}
